...
abstract class CommonObject
{
	...
	public function showOptionalsNew($extrafields, $mode = 'view', $params = null, $keysuffix = '', $keyprefix = '', $onetrtd = 0,$field='')
	{
		global $db, $conf, $langs, $action, $form;
		...
		$out = '';
		//var_dump($extrafields->attributes[$this->table_element]['label']); die; && ($extrafields->attributes[$this->table_element]['label']==$field)
		//var_dump($extrafields->attributes[$this->table_element]['label'][$field]); 
		//print strlen($extrafields->attributes[$this->table_element]['label'][$field]);
		//die;
		
		if (is_array($extrafields->attributes[$this->table_element]['label']) && count($extrafields->attributes[$this->table_element]['label']) > 0 && (strlen($extrafields->attributes[$this->table_element]['label'][$field])>0))
		{
			$out .= "\n";
			$out .= '<!-- showOptionalsInput --> ';
			$out .= "\n";
