...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_fsp.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele fsp
 */
...
/**
 *	Class to generate PDF proposal fsp
 */
class pdf_fsp extends ModelePDFPropales
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->db = $db;
        $this->name = "fsp";
        $this->description = $langs->trans('DocModelfspDescription');
...
/// fin
        if ($conf->facture->dir_output)
        {
            ...
            else
            {
                $objectref = dol_sanitizeFileName($object->ref);
                $dir = $conf->propal->multidir_output[$object->entity] . "/" . $objectref;
                $file = $dir . "/fiche_souscription_" . $objectref . ".pdf";
            }
