...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_appel_fond.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele appel_fond
 */
...
/**
 *	Class to generate PDF proposal appel_fond
 */
class pdf_appel_fond extends ModelePDFPropales
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->db = $db;
        $this->name = "appel_fond";
        $this->description = $langs->trans('DocModelappel_fondDescription');
...
//recupération des infos de la souscription
               ...
               // $sql.= ' f.datec as date_creation, f.tms as date_update,';
                ...
                $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."propal as p ON s.rowid=p.fk_soc";
...
'), 0, 'L');
                ...
                $sql1.= ' WHERE pe.fk_object ='.$objet->prid;
