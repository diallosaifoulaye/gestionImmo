...
<?php
	...
	?>
    <?php $qtyDefaut = 1; ?>
	<td class="nobottom linecolqty right"><input type="text" size="2" name="qty" id="qty" readonly class="flat right" value="<?php echo (isset($_POST["qty"])?GETPOST("qty", 'alpha', 2):$qtyDefaut); ?>">
	</td>
	<?php
	if($conf->global->PRODUCT_USE_UNITS)
	{
