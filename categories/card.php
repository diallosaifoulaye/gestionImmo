...
if ($user->rights->categorie->creer)
{
	...
	if ($action == 'create' || $_POST["addcat"] == 'addcat')
	{
		...
		// Ref
		print '<tr>';
		print '<td class="titlefieldcreate fieldrequired">'.$langs->trans("label").'</td><td><input id="label" class="minwidth100" name="label" value="'.$label.'">';
		print'</td></tr>';
     ...
     <?php
		...
		if (empty($reshook))
		{
			...
			//print $object->showOptionalsNew($extrafields, 'edit');
          ...
          /*  print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'pays');*/
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'bv_ville');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'region');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'bv_pays');


            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'os_nom');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'os_interlocuteur');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'os_num_compte');

            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'resp_clientelele');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'assist_commerciale');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'notaire_vente');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'interl_notaire');

          /*  print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'bv_adresse');*/

          /*
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'bv_tel');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'bv_fax');
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'bv_email');*/
    ...
    // Parent category
		...
		print '<input type="submit" class="button" value="'.$langs->trans("CreateCat").'" name="creation" />';
		print '&nbsp; &nbsp; &nbsp;';
