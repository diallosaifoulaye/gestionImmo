...
/**
 *	\file       htdocs/includes/modules/facture/doc/pdf_promesse.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate invoices from crab model
 *	\author	    Laurent Destailleur
 *	\version    $Id: pdf_promesse.modules.php,v 1.12 2011/07/31 23:28:15 eldy Exp $
 */
...
/**
 *	\class      pdf_promesse
 *	\brief      Classe permettant de generer les factures au modele promesse
 */

class pdf_promesse extends ModelePDFFactures
{
	...
	function pdf_promesse($db)
	{
		...
		$this->db = $db;
		$this->name = "promesse";
		$this->description = $langs->trans('PDFpromesseDescription');
