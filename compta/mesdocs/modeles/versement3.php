...
$pdf->MultiCell(0,6,''.utf8_decode('Nous soussignés, ').utf8_decode($conf->global->MAIN_INFO_SOCIETE_NOM).htmlspecialchars_decode(',Attestons par la présente avoir recu en date du : '.dol_print_date($paiement2->date,'day')),0,'L');
$y=$y+6;
...
$file = $dir . "/" ;
$pdf->Output($file.'versement_3'.dol_sanitizeFileName($object->ref).'pdf','F');
