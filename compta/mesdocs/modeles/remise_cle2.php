...
$idcategorie = $pr->get_Id_Categorie($id_cat);
...
{
    // Logo
    $this->Image('/home/www/1ad5b497e43a3518625aabfca63d861a/web/gescom/htdocs/includes/modules/facture/doc/papier-entete-sablux.jpg',10,6,180,290);
...
$pdf->MultiCell(0,6,''.utf8_decode('Nous soussignés, ').html_entity_decode($cat->societe).utf8_decode(', 

Représentée par '. $conf->global->MAIN_INFO_SOCIETE_MANAGERS.', Co-Gérant de ladite société :'),0,1);
$y=$y+15;
/*$pdf->SetXY($x,$y);
...
$dir = $conf->facture->dir_output . "/" . $invoice2->ref.'/'.$id;
		...
		$file = $dir . "/" ;
$pdf->Output($file.'remise_cle.pdf','F');
?>