...
function print_liste_field_titre2($name, $file="", $field="", $begin="", $moreparam="", $td="", $sortfield="", $sortorder="", $id_cat="", $mois_com="")
{
    global $conf;
    //print "$name, $file, $field, $begin, $options, $td, $sortfield, $sortorder<br>\n";
    ...
    if ($field)
    {
        ...
        if (! $sortorder)
        {
            print '<a href="'.$file.'?id_cat='.$id_cat.'&mois_com='.$mois_com.'&sortfield='.$field.'&sortorder=asc&begin='.$begin.$options.'">'.img_down("A-Z",0).'</a>';
            print '<a href="'.$file.'?id_cat='.$id_cat.'&mois_com='.$mois_com.'&sortfield='.$field.'&sortorder=desc&begin='.$begin.$options.'">'.img_up("Z-A",0).'</a>';
        }
        else
        {
            if ($field != $sortfield)
            {
                ...
                if ($sortorder == 'DESC' ) {
                    print '<a href="'.$file.'?id_cat='.$id_cat.'&mois_com='.$mois_com.'&sortfield='.$field.'&sortorder=asc&begin='.$begin.$options.'">'.img_down("A-Z",0).'</a>';
                    print '<a href="'.$file.'?id_cat='.$id_cat.'&mois_com='.$mois_com.'&sortfield='.$field.'&sortorder=desc&begin='.$begin.$options.'">'.img_up("Z-A",1).'</a>';
                }
                if ($sortorder == 'ASC' ) {
                    print '<a href="'.$file.'?id_cat='.$id_cat.'&mois_com='.$mois_com.'&sortfield='.$field.'&sortorder=asc&begin='.$begin.$options.'">'.img_down("A-Z",1).'</a>';
                    print '<a href="'.$file.'?id_cat='.$id_cat.'&mois_com='.$mois_com.'&sortfield='.$field.'&sortorder=desc&begin='.$begin.$options.'">'.img_up("Z-A",0).'</a>';
                }
            }
        }
