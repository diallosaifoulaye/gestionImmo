...
class Facture extends CommonInvoice
{
    ...
    public function fetch($rowid, $ref = '', $ref_ext = '', $ref_int = '', $fetch_situation = false)
	{
		...
		$sql.= ', f.fk_account';
       // $sql.= ', m.rowid as motifid,m.label as motiflabel,m.code as codemotif';
		...
		//$sql.= ' LEFT JOIN '.MAIN_DB_PREFIX.'motif as m ON m.rowid = p.fk_motif';
    ...
    public function fetch_lines()
	{
		...
		$sql.= ' p.ref as product_ref, p.fk_product_type as fk_product_type, p.label as product_label, p.description as product_desc, p.weight,';
		$sql.= 'p.length,p.surface,p.surface_units,p.volume,p.rowid as rowpr';
    ...
    public function  set_paid($user, $close_code = '', $close_note = '')
	{
		...
		if ($this->paye != 1)
		{
			...
			if ($resql)
			{
                ...
                $sql2 = 'UPDATE '.MAIN_DB_PREFIX.'product SET tosell = 3 WHERE rowid = '.$this->lines[0]->fk_product;
    ...
    public function initAsSpecimen($option = '')
	{
		...
		$this->motifid = '';	// Not forced to show payment mode CHQ + VIR
