...
else
{
	...
	if ($action == 'create' && $usercancreate)
    {
        ...
        if ($type != 1)	// Nature, Weight and volume only applies to products and not to services
        {
            ...
            $statutarray = array('1' => $langs->trans("Finished"), '0' => $langs->trans("RowMaterial"), '2' => $langs->trans("marchandise"));
        ...
        if (empty($reshook))
        {
            ...
            print $object->showOptionalsNew($extrafields, 'edit', $parameters,'','',0,'typeprod');
		...
		else // For external software
		{
			// Accountancy_code_sell
			print '<tr><td class="titlefieldcreate">'.$langs->trans("ProductAccountancySellCode").'</td>';
			print '<td class="maxwidthonsmartphone">';print select_numcompte($selected='',$htmlname='accountancy_code_sell',$empty=0, $htmloption='');
			...
			{
				print '<tr><td class="titlefieldcreate">'.$langs->trans("ProductAccountancySellIntraCode").'</td>';
                print '<td class="maxwidthonsmartphone">';print select_numcompte($selected='',$htmlname='accountancy_code_sell_intra',$empty=0, $htmloption='');
			...
			// Accountancy_code_sell_export
			print '<tr><td class="titlefieldcreate">'.$langs->trans("ProductAccountancySellExportCode").'</td>';
            print '<td class="maxwidthonsmartphone">';print select_numcompte($selected='',$htmlname='accountancy_code_sell_export',$empty=0, $htmloption='');
            ...
            */print '</td></tr>';
			...
			// Accountancy_code_buy
			print '<tr><td>'.$langs->trans("ProductAccountancyBuyCode").'</td>';
            print '<td class="maxwidthonsmartphone">';print select_numcompte($selected='',$htmlname='accountancy_code_buy',$empty=0, $htmloption='');
			...
			*/print '</td></tr>';
			...
			{
				print '<tr><td class="titlefieldcreate">'.$langs->trans("ProductAccountancyBuyIntraCode").'</td>';
                print '<td class="maxwidthonsmartphone">';print select_numcompte($selected='',$htmlname='accountancy_code_buy_intra',$empty=0, $htmloption='');
			...
			// Accountancy_code_buy_export
			print '<tr><td class="titlefieldcreate">'.$langs->trans("ProductAccountancyBuyExportCode").'</td>';
            print '<td class="maxwidthonsmartphone">';print select_numcompte($selected='',$htmlname='accountancy_code_buy_export',$empty=0, $htmloption='');
    ...
    elseif ($object->id > 0)
    {
		...
		if ($action == 'edit' && $usercancreate)
		{
			...
			{
				// Accountancy_code_sell
				print '<tr><td class="titlefield">'.$langs->trans("ProductAccountancySellCode").'</td><td>';
                print select_numcompte($selected=$object->accountancy_code_sell,$htmlname='accountancy_code_sell',$empty=0, $htmloption='');
				...
				if ($mysoc->isInEEC())
				{
					print '<tr><td class="titlefield">'.$langs->trans("ProductAccountancySellIntraCode").'</td><td>';
                    print select_numcompte($selected=$object->accountancy_code_sell_intra,$htmlname='accountancy_code_sell_intra',$empty=0, $htmloption='');
				...
				// Accountancy_code_sell_export
				print '<tr><td class="titlefield">'.$langs->trans("ProductAccountancySellExportCode").'</td><td>';
                print select_numcompte($selected=$object->accountancy_code_sell_export,$htmlname='accountancy_code_sell_export',$empty=0, $htmloption='');

               /* print '<td><input name="accountancy_code_sell_export" class="maxwidth200" value="'.$object->accountancy_code_sell_export.'">';*/
				print '</td></tr>';

				// Accountancy_code_buy
				print '<tr><td>'.$langs->trans("ProductAccountancyBuyCode").'</td><td>';
                print select_numcompte($selected=$object->accountancy_code_buy,$htmlname='accountancy_code_buy',$empty=0, $htmloption='');
				...
				if ($mysoc->isInEEC())
				{
					print '<tr><td class="titlefield">'.$langs->trans("ProductAccountancyBuyIntraCode").'</td><td>';
                    print select_numcompte($selected=$object->accountancy_code_buy_intra,$htmlname='accountancy_code_buy_intra',$empty=0, $htmloption='');
				...
				// Accountancy_code_buy_export
				print '<tr><td class="titlefield">'.$langs->trans("ProductAccountancyBuyExportCode").'</td><td>';
                print select_numcompte($selected=$object->accountancy_code_buy_export,$htmlname='accountancy_code_buy_export',$empty=0, $htmloption='');
