...
if ($resql)
{
    ...
    $param.=isset($typeprod)?"&amp;type=".$typeprod:"";
    ...
    else
    {
        ...
        if ($conf->service->enabled && $typeprod != 0) print_liste_field_titre($langs->trans("Duration"), $_SERVER["PHP_SELF"], "p.duration",$param,"",'align="center"',$sortfield,$sortorder);
        ...
        if ($conf->stock->enabled && $user->rights->stock->lire && $typeprod != 1) print '<td class="liste_titre" align="right">'.$langs->trans("PhysicalStock").'</td>';
        ...
        while ($i < min($num,$limit))
        {
            ...
            print $product_static->getNomUrlTerrain(1,'',24);
            print "</td>\n";
        ...
        if ($num > $conf->liste_limit)
        {
            ...
            {
                print_barre_liste('', $page, "liste.php", "&amp;sref=$sref&amp;snom=$snom&amp;fourn_id=$fourn_id".(isset($typeprod)?"&amp;type=$typeprod":"")."&amp;tosell=".$tosell."&amp;tobuy=".$tobuy, $sortfield, $sortorder,'',$num);
            }
        }
